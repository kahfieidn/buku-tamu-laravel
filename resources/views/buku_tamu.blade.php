                ...
                <section id="multiple-column-form">
                    <div class="row match-height">
                        ...
                        <div class="card-content">
                                    <div class="card-body">
                                        <form action"{{ route('buku_tamu.store') }} method="POST" class="form" enctype="multipart/form-data">
                                        @csrf
                                            <div class="row">
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="nama_pemohon" class="form-control"
                                                            placeholder="Nama Pemohon" name="nama_pemohon">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    ...
                                                    <select class="choices form-select" name="urusan_tujuan_id" id="urusan_tujuan_id">
                                                        ...
                                                        @foreach($urusan_tujuans as $urusan_tujuan)
                                                        <option value="{{ $urusan_tujuan->id }}">{{ $urusan_tujuan->urusan_tujuan }}</options>
                                                        @endforeach
                                                    </select>
                                                </div>
