                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" id="name" class="form-control" name="name" placeholder="Nama User">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-12">
                                                                        <div class="form-group">
                    ...
                    <table class="table table-striped" id="table1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <div class="buttons">
                                    <a href="{{ route('user.show', $user->id) }}" class="btn btn-warning rounded-pill">Edit</a>
                                    <button class="btn btn-danger rounded-pill" data-bs-toggle="modal" data-bs-target="#exampleModalCenter{{ $user->id }}">Hapus</button>
                                </div>
                                </td>
                            </tr>
                            @endforeach
...
<div class="modal fade" id="exampleModalCenter{{ $user->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                    Dengan menekan "Ya", Artinya anda setuju untuk menghapus {{ $user->name }} dari data anda.
                </p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-light-secondary" data-bs-dismiss="modal">
