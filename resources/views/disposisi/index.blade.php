                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        <div class="form-group">
                                                                            <label for="first-name-vertical">Nama Disposisi</label>
                                                                            <input type="text" id="nama_disposisi" class="form-control" name="nama_disposisi" placeholder="Nama Disposisi">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                    ...
                    <table class="table table-striped" id="table1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <div class="buttons">
                                    <a href="{{ route('disposisi.show', $disposisi->id) }}" class="btn btn-warning rounded-pill">Edit</a>
                                    <button class="btn btn-danger rounded-pill" data-bs-toggle="modal" data-bs-target="#exampleModalCenter{{ $disposisi->id }}">Hapus</button>
                                </div>
                                </td>
                            </tr>
                            @endforeach
...
@foreach ($disposisis as $disposisi)
<div class="modal fade" id="exampleModalCenter{{ $disposisi->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                    Dengan menekan "Ya", Artinya anda setuju untuk menghapus {{ $disposisi->nama_disposisi }} dari data anda.
                </p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-light-secondary" data-bs-dismiss="modal">
