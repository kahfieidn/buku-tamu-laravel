            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form action="{{ route('disposisi.update', $disposisis->id) }}" method="POST" enctype="multipart/form-data">
                                @method('put')
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="nama_disposisi" class="form-control" name="nama_disposisi" placeholder="Nama Disposisi" value="{{ $disposisis->nama_disposisi }}">
                                        </div>
                                    </div>
